            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color:StudentTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      StudentTheme.nearlyDarkBlue.withOpacity(0.2),
                      StudentTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: StudentTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: StudentTheme.white.withOpacity(
