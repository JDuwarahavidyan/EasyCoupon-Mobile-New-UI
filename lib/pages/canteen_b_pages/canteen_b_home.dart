...
class CanteenBHome extends StatefulWidget {
  const CanteenBHome({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CanteenBHomeState createState() => _CanteenBHomeState();
}

class _CanteenBHomeState extends State<CanteenBHome> with TickerProviderStateMixin, RouteAware {
